...
export const PLUGIN_UPDATE_BRANCH = "master";
export const PLUGIN_UPDATE_MANIFEST_PATH = "release/latest.json";
export const PLUGIN_UPDATE_CHANGELOG_PATH = "CHANGELOG.md";
export const PLUGIN_UPDATE_ARTIFACT_DIR = "release/friday-obsidian-plugin";
...
export const PLUGIN_UPDATE_LOG_VAULT_PATH = "F.R.I.D.A.Y/Friday Update 更新日志.md";

...
test("llm transport policy retries transient gateway failures", async () => {
	...
	assert.equal(mod.shouldRetryLlmRequest("Error: net::ERR_HTTP2_PROTOCOL_ERROR", 1, 3), true);
	...
	assert.equal(mod.isRetryableLlmFailure("net::ERR_HTTP2_PROTOCOL_ERROR"), true);
